        ...
        <form action="{{ route('update-account', [
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <div class="w-1/2 px-8 ">
                    <div class="text-2xl mb-4">Update Account Information</div>
                    <div class="grid grid-cols-2 gap-y-2 gap-x-4">
                        <div class="flex flex-col gap-1 w-full">
                            ...
                            <input type="text" name="account-name"
                                ...
                                value="{{ old('account-name', $account['Name'] ?? '') }}">
                            @error('account-name')
                        ...
                        <div class="flex flex-col gap-1 w-full">
                            ...
                            <input type="text" name="account-number"
                                class="border rounded-md px-3 py-2 inline-block w-full"
                                value="{{ old('account-number', $account['AccountNumber'] ?? '') }}">
                        ...
                        <div class="flex flex-col gap-1 w-full">
                            ...
                            <input type="text" name="account-site"
                                class="border rounded-md px-3 py-2 inline-block w-full"
                                value="{{ old('account-site', $account['Site'] ?? '') }}">
                            @error('account-site')
                                <div class="text-sm text-red-600 dark:text-red-400 space-y-1"> {{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col gap-1 w-full">
                            ...
                            <input type="text" name="ticker-symbol"
                                class="border rounded-md px-3 py-2 inline-block w-full"
                                value="{{ old('ticker-symbol', $account['TickerSymbol'] ?? '') }}">
                            @error('ticker-symbol')
                                <div class="text-sm text-red-600 dark:text-red-400 space-y-1"> {{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col gap-1 w-full">
                            ...
                            <input type="text" name="employees"
                                class="border rounded-md px-3 py-2 inline-block w-full"
                                value="{{ old('employees', $account['NumberOfEmployees']) ?? '' }}">
                            @error('employees')
                                <div class="text-sm text-red-600 dark:text-red-400 space-y-1"> {{ $message }}</div>
                            @enderror
                        </div>
                ...
                <button type="submit"
                    class="px-4 py-2 mt-4 rounded-md bg-blue-400 hover:cursor-pointer hover:text-white transition-all">Update</button>
            </div>
        </form>
</x-app-layout>
