        ...
        <div class="w-1/3">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('create-account') }}"
                    class="bg-red-300 px-2 py-1 rounded-sm hover:text-white transition-all">Create
                    New Account</a>
            </div>
                    ...
                    <a href="#">
                        <li class="pb-3 sm:pb-4">
                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                <div class="shrink-0">
                                    <div class="w-10 h-10 bg-red-200 rounded-full flex justify-center items-center">
